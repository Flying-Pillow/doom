import type { MissionBrief, MissionArtifactKey, MissionStageId, MissionTaskAgent, MissionTaskStatus } from '../../../types.js';
...
export type MissionStageTemplateDefinitions = Record<MissionStageId, MissionStageTemplateDefinition>;
